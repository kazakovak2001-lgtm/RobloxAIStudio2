...
**Current backend runtime release:** `release/cutover-1e-candidate@d3ddcce4408b950dc2ebe1ef2767998f93e83970`
...
| `PIPELINE-1B` | Conditional stages and a validation gate inside the pipeline | High | Not scoped — begins with which stage to add and what it may block | `PIPELINE-1A` |
...
- Active paired runtime baseline: backend `d3ddcce4408b950dc2ebe1ef2767998f93e83970` plus protected Frontend contents `6c1458d836244f2b720f361a78c2ab13f1682f74`. The backend identity advanced from `12bd4dc6c736aa6af7b3346624152032157d5bd1` with the PIPELINE-1A merge, a real executable change rather than a documentation-only descendant; that identity in turn advanced from `d7e444549d324df9df339ff5bda7a75a820e39e3` with the ARTIFACT-1, PROVIDER-1B and SECREVIEW-1 merges. The Frontend identity is unchanged, confirmed by the paired production contract staying green against the existing pin. Control-only reconciliation commits may follow these runtime identities; release evidence remains bound to this exact executable pair.
