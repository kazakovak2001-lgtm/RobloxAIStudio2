...
**Current backend runtime release:** `release/cutover-1e-candidate@243116da73808cc4a1202cb007d9bd1f2dad2b69`
...
| `REPAIR-1` | Artifact-applying repair, redelivery, and revalidation | High | 🔧 In progress — REPAIR-1A landed (backend PR #185, Frontend PR #38); Studio redelivery (1B) and rollback/audit (1C) remain | `RUNTIME-PLAYTEST-1` |
...
- Active paired runtime baseline: backend `243116da73808cc4a1202cb007d9bd1f2dad2b69` plus protected Frontend contents `33cb19310ad15097eac1ff53832ee7d8191bd65e`. Control-only reconciliation commits may follow these runtime identities; release evidence remains bound to this exact executable pair.
