...
**Current backend runtime release:** `release/cutover-1e-candidate@ecae9bb59f1639d2e382e7221a956aa96460b3e9`
...
- Active paired runtime baseline: backend `ecae9bb59f1639d2e382e7221a956aa96460b3e9` plus protected Frontend contents `6c1458d836244f2b720f361a78c2ab13f1682f74`. The backend identity advanced from `ccd28ef816d1653df0aebd0775f70187aa321564` with the PROVIDER-1A merge, which is a real executable change rather than a documentation-only descendant; the Frontend identity is unchanged. Control-only reconciliation commits may follow these runtime identities; release evidence remains bound to this exact executable pair.
