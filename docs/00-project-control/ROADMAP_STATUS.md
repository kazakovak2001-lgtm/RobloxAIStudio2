...
- Active paired runtime baseline: backend `d7e444549d324df9df339ff5bda7a75a820e39e3` plus protected Frontend contents `6c1458d836244f2b720f361a78c2ab13f1682f74`. The backend identity advanced from `ecae9bb59f1639d2e382e7221a956aa96460b3e9` with the STUDIO-2F-A merges, which are real executable changes rather than documentation-only descendants; the Frontend identity is unchanged, confirmed by the paired production contract staying green against the existing pin. Control-only reconciliation commits may follow these runtime identities; release evidence remains bound to this exact executable pair.
