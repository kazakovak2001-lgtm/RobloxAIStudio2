...
**Current backend runtime release:** `release/cutover-1e-candidate@12bd4dc6c736aa6af7b3346624152032157d5bd1`
...
- Active paired runtime baseline: backend `12bd4dc6c736aa6af7b3346624152032157d5bd1` plus protected Frontend contents `6c1458d836244f2b720f361a78c2ab13f1682f74`. The backend identity advanced from `d7e444549d324df9df339ff5bda7a75a820e39e3` with the ARTIFACT-1, PROVIDER-1B and SECREVIEW-1 merges, which are real executable changes rather than documentation-only descendants; the Frontend identity is unchanged, confirmed by the paired production contract staying green against the existing pin. Control-only reconciliation commits may follow these runtime identities; release evidence remains bound to this exact executable pair.
