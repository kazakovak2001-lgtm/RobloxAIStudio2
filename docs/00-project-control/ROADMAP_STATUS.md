...
| CORE-1        | Real project data, persistence, and API contract stabilization | Critical | 🟡 CORE-1b implemented; validating | CI-BASELINE-1         |
...
See [CORE-1B_DURABLE_RUNTIME.md](./CORE-1B_DURABLE_RUNTIME.md) for blueprint, execution, chat, and PostgreSQL restart acceptance scope.
