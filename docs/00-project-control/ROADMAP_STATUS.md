...
| CORE-1        | Real project data, persistence, and API contract stabilization | Critical | 🟡 In progress (CORE-1a) | CI-BASELINE-1         |
...
See [CORE-1A_DURABLE_PROJECTS.md](./CORE-1A_DURABLE_PROJECTS.md) for the active sprint's scope, contract review, and remaining work.
