...
export class LuaGeneratorAgent extends BaseAgent {
  ...
  public readonly inputSchema: Record<string, unknown> = { type: "object", properties: { architecture: { type: "object" }, gameDesign: { type: "object" } }, required: ["architecture", "gameDesign"] };
  public readonly outputSchema: Record<string, unknown> = { type: "object", properties: { generatedCode: { type: "object" } }, required: ["generatedCode"] };
  ...
  protected async process(_input: AgentInput): Promise<Record<string, unknown>> {
    return { generatedCode: { scripts: [], modules: {} } };
  }
}
