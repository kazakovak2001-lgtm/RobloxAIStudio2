...
import { StatusIndicator } from "@/shared/ui/system";
      ...
      <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-400">
            Coordinate projects, agents, and AI generation from a unified view.
          </p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-4">
        ...
        <Card>
          ...
          <p className="mt-3 flex items-center gap-2 text-2xl font-semibold text-white">
            {backendOnline ? (
              <>
                <Wifi className="h-5 w-5 text-success-400" /> Online
              </>
            ) : (
              <>
                <WifiOff className="h-5 w-5 text-error-400" /> Offline
              </>
            )}
          </p>
        </Card>
          ...
          <Card>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex items-center justify-between text-sm text-slate-400">
                ...
                <StatusIndicator status="warning" label="Standby" />
              </div>
            </div>
          </Card>
        </div>
